  ...
  return (
    <section id="tentang-saya" className="w-full py-12 md:py-24 lg:py-32 bg-secondary/30">
      <div className="container mx-auto px-4 md:px-6">
        <h2 className="text-3xl font-bold tracking-tighter text-center sm:text-5xl mb-12 text-gray-800 dark:text-gray-100">Tentang Saya</h2>
        <div className="grid items-start gap-12 lg:grid-cols-5">
            <div className="space-y-4 lg:col-span-3">
              <p className="text-gray-600 md:text-xl/relaxed dark:text-gray-300">
            ...
            <div className="flex flex-col gap-6 lg:col-span-2">
              <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Saya juga merupakan:</h3>
              <ul className="space-y-4">
                {achievements.map((item, index) => (
                  <li key={index} className="flex items-start gap-4">
                    ...
                    <span className="flex-1 pt-1 text-gray-700 dark:text-gray-200">{item.text}</span>
                  </li>
                ))}
              </ul>
            </div>
