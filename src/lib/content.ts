export const content = {
  id: {
    ...
    description: 'Portofolio pribadi untuk Annisa Ramadhona - Pendidik Matematika, Guru SEA, Penulis Akademik, dan Inovator Pendidikan.',
    navLinks: [
  ...
  en: {
    ...
    navLinks: [
      { name: 'About Me', href: '#tentang-saya' },
      { name: 'Portfolio', href: '#portofolio' },
      { name: 'Skills', href: '#keahlian' },
    ...
    skills: {
      ...
      skillList: [
        ...
        { name: 'Scientific & Essay Writing', icon: 'FileText' },
        { name: 'Public Speaking & Debate', icon: 'Mic' },
        { name: 'Educational Content Creation', icon: 'Film' },
        { name: 'Classroom Management', icon: 'Users' },
        { name: 'Cross-Cultural Teaching', icon: 'Globe2' },
